...
<div class="sidebar">
    ...
    <nav>
        ...
        <div class="nav-item">
            <a href="<?php echo e(route('siswa.index')); ?>" class="<?php echo e(request()->routeIs('siswa.*') ? 'active' : ''); ?>">
                <span class="nav-icon"><i class="bi bi-people-fill"></i></span>
                Data Siswa
            </a>
        </div>
        <div class="nav-item">
            <a href="<?php echo e(route('prestasi.index')); ?>" class="<?php echo e(request()->routeIs('prestasi.*') ? 'active' : ''); ?>">
                <span class="nav-icon"><i class="bi bi-trophy-fill"></i></span>
                Data Prestasi
            </a>
        </div>
        <div class="nav-item">
            <a href="<?php echo e(route('kelas.index')); ?>" class="<?php echo e(request()->routeIs('kelas.*') ? 'active' : ''); ?>">
...
<div class="main-wrapper">
    <div class="topbar">
        <h6><i class="bi bi-grid-fill me-2 text-success"></i><?php echo $__env->yieldContent('page-title', 'Dashboard'); ?></h6>
        <div class="topbar-right">
            <span class="badge-date"><i class="bi bi-calendar3 me-1"></i><?php echo e(now()->translatedFormat('d F Y')); ?></span>
            <?php if(auth()->guard()->check()): ?>
            <div class="topbar-user">
                <div class="t-avatar"><?php echo e(strtoupper(substr(Auth::user()->name, 0, 1))); ?></div>
                <span class="t-name"><?php echo e(Auth::user()->name); ?></span>
            </div>
            <?php endif; ?>
        </div>
    </div>
...
<?php /**PATH E:\sistem-prestasi-laravel9-FIXED\fixed-project\resources\views/layouts/app.blade.php ENDPATH**/ ?>