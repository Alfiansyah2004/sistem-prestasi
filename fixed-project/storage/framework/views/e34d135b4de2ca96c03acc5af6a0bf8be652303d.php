        ...
        <form method="POST" action="<?php echo e(route('register')); ?>">
            ...
            <div class="input-group-custom">
                ...
                <input type="text" name="nama" value="<?php echo e(old('nama')); ?>"
                    ...
                    class="<?php echo e($errors->has('nama') ? 'is-invalid' : ''); ?>"
                    required autofocus>
...
</html><?php /**PATH E:\sistem-prestasi-laravel9-FIXED\fixed-project\resources\views/auth/register.blade.php ENDPATH**/ ?>